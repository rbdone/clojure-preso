...
The `home-routes` handler in the `my-web.routes.home` namespace
...
The `home-page` function will in turn call the `my-web.layout/render` function
...
The routes are aggregated and wrapped with middleware in the `my-web.handler` namespace:
...
Request middleware functions are located under the `my-web.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `my-web.dev-middleware` namespace found in
